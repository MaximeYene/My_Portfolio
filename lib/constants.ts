...
export const PROJECTS = [
  ...
  },
  {
    title: "Skip Hire",
    description:
      "Plateforme web de location de bennes avec interface intuitive et gestion des réservations en temps réel.",
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description:
      "Responsable du développement frontend et backend, intégration ML et déploiement.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Contribution au développement fullstack, API et optimisation des performances.",
    achievements: [
...
export const INTERESTS = [
  {
    icon: "Music",
    label: "Musique",
    description: "Passion pour les différents genres musicaux",
  },
  {
    icon: "Plane",
    label: "Voyage",
    description: "Explorer le monde et les cultures",
  },
  {
    icon: "Gamepad2",
    label: "Jeux vidéo",
    description: "Gaming et compétition",
  },
  {
    icon: "Zap",
    label: "Sports",
    description: "Activité physique et bien-être",
  },
  {
    icon: "Code",
    label: "Programmation",
    description: "Création d'innovations technologiques",
  },
];
