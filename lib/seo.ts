...
export const baseMetadata: Metadata = {
  ...
  description:
    "Portfolio professionnel - Ingénieur Fullstack & DevOps spécialisé en Machine Learning, innovation startup et solutions cloud.",
  keywords: [
    "Ingénieur Fullstack",
    "DevOps",
    "Machine Learning",
  ...
  openGraph: {
    title: "Joseph Maxime YENE - Ingénieur Fullstack & DevOps",
    description:
      "Découvrez mon portfolio professionnel avec mes projets innovants, expériences et compétences techniques.",
    type: "website",
    locale: "fr_FR",
  ...
  twitter: {
    ...
    title: "Joseph Maxime YENE - Ingénieur Fullstack & DevOps",
    description:
      "Portfolio professionnel - Ingénieur Fullstack & DevOps | minato.ai",
  },
  alternates: {
