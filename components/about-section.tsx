...
const interests = [
  { icon: Music, label: 'Musique', description: 'J\'aime écouter et créer de la musique dans mon temps libre.' },
  { icon: Plane, label: 'Voyages', description: 'Explorer de nouveaux pays et cultures est un passe-temps que je chéris.' },
  { icon: Gamepad2, label: 'Jeux vidéo', description: 'Je joue régulièrement à des jeux vidéo pour me détendre.' },
  { icon: Zap, label: 'Technologie', description: 'Je suis toujours à la recherche des dernières avancées technologiques.' },
  { icon: Code, label: 'Développement', description: 'Coder est ma passion et je m\'efforce constamment d\'améliorer mes compétences.' },
]
        ...
        >
          ...
          >
            <div className="space-y-6">
              ...
              <div className="pt-6">
                <p className="text-sm font-semibold text-accent mb-3">{t.about.languages.french.toUpperCase()} / {t.about.languages.english.toUpperCase()}</p>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground">{t.about.languages.french}</span>
                    <span className="text-xs text-accent">{t.about.languages.level_native}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground">{t.about.languages.english}</span>
                    <span className="text-xs text-accent">{t.about.languages.level_professional}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {interestsData.map((interest) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="font-semibold text-foreground mb-2">{interest.label}</h4>
                </motion.div>
              )
            })}
          </motion.div>
